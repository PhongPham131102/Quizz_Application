                        ...
                        children: [
                          Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      color: Color.fromARGB(255, 195, 112, 49),
                                      width: 4)),
                                                              ...
                                                              ? Padding(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      GlowText(
                                                                        "Số lượng: " +
                                                                            usersitemMap[itemsfilter![index * 2].id]!.quantity.toString(),
                                                                        style: TextStyle(
                                                                            color: Colors
                                                                                .yellowAccent,
                                                                            fontSize:
