...
class _KahootViewState extends State<KahootView> implements KahootContract {
  ...
  @override
  void setisloading(bool _isloading) {_hideKeyboard();
                              ...
                              children: [
                                ...
                                Text("${name}",
                                    style: TextStyle(
                                        ...
                                        color: Color.fromARGB(255, 248, 32, 3),
                                ...
                                CustomText("${totalscore} điểm",
                                    ...
                                    style: TextStyle(
                                        fontFamily: 'Mitr',
                                        fontSize: 25,
                                        color: Color.fromARGB(255, 89, 248, 3),
                                        fontWeight: FontWeight.w700)),
                              ],
                            ),
                          )
                                ...
                                children: [
                                  Column(
                                      ...
                                      children: [
                                        ...
                                        listQuestionsTheme[indexQuestion].image !=
                                                ""
                                            ? Padding(
                                                padding:
